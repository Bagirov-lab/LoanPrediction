...
param_grid = {"randomforestclassifier__n_estimators": [10, 20, 30],
              ...
              "randomforestclassifier__min_impurity_decrease": [None, 0.1, 0.2, 0.3]}
...
with open(os.path.abspath('model') + '/' + filename, 'wb') as file:
    pickle.dump(grid, file)

with open(os.path.abspath('model') + '/' + filename, 'rb') as f:
